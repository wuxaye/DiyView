...
import com.xaye.helper.net.BaseNetConstant
 ...
 *
 * () -> Unit：这表示 requestDslClass 是一个函数类型的参数，
 *
 * 也可以等同下面写法，就算把 HttpRequestDsl 对象传进去，懂吧！
 *
 * val dslBuilder = HttpRequestDsl()
 * dslBuilder.apply {
 ...
 *     }
 * }
 * BaseViewModel.rxHttpRequest(dslBuilder)
 */
